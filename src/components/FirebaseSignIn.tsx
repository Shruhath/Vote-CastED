...
export function FirebaseSignIn({ logoUrl }: FirebaseSignInProps) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="w-full p-4">
        {logoUrl ? (
          <img src={logoUrl} alt="Vote Casted Logo" className="h-10 w-auto" />
        ) : (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center px-4 py-3 border border-black bg-white text-black font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
